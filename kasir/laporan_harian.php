...
function tgl_indo($tanggal)
{
 ...
 ?></td>
              ...
              <a href="laporan_harian_pdf.php?tanggal_dari=<?php echo $tgl_dari ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
              <a href="laporan_harian_print.php?tanggal_dari=<?php echo $tgl_dari ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
              <a href="laporan_harian_excel.php?tanggal_dari=<?php echo $tgl_dari ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-print"></i> &nbsp CETAK EXCEL</a>
