...
?>
            ...
            <form action="penjualan_act.php" method="post" name="penjualan" id="transaksi-form">
...
?>
              ...
              <div class="col-lg-3">
                ...
                <div class="form-group">
                  <label>Shif</label>
                  <input type="text" class="form-control" required="required" name="pelanggan" placeholder="shift" id="shif">
                </div>
              ...
              <div class="col-lg-3">
                ...
                <div class="row">
                 ...
                 <div class="form-group col-lg-7">
                  ...
                  <input type="text" class="form-control" name="kode_produk" id="tambahkan_kode" placeholder="Masukkan Kode Produk ..">
                </div>
...
?>
          ...
          <div class="form-group">
            ...
            <button id="buat-transaksi"  type="button" class="btn btn-success pull-right"><i class="fa fa-check"></i> Buat Transaksi</button>
          </div>
...
<script>
  const shifInput = document.getElementById('shif')
   shifInput.value = localStorage.getItem('shif')
</script>
