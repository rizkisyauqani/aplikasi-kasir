...
?>
  ...
  $(document).ready(function() {
   ...
   // Function to validate and confirm transaction
  function cek() {
    var total = $(".total_pembelian").attr("id");
    if (total == 0 || total == "") {
      alert("Pilih produk yang akan dibeli.");
      return false;
    } else {
      return confirm("Yakin ingin menyimpan transaksi?");
    }
  }

  // Bind cek function to the 'Buat Transaksi' button click
