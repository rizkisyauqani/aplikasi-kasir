...
<body class="hold-transition skin-green layout-top-nav">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li>
                    <a href="produk_barcode.php">
                      <i class="fa fa-folder"></i> <span>BARCODE PRODUK</span>
                    </a>
                  </li>
 ...
 <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-file"></i> &nbsp; Laporan <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li>
                    <a href="laporan.php">
                  ...
                  <li>
                    <a href="laporan_harian.php">
                      <i class="fa fa-file"></i> <span>LAPORAN HARIAN</span>
                    </a>
                  </li>
                </ul>
              </li>
