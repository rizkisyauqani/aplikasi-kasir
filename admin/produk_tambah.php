<?php include 'header.php';require '../library/vendor/autoload.php';?>

<div class="content-wrapper" onload="document.kodeBarang.kode.focus()">
...
?>
          <form action="produk_act.php" method="post" enctype="multipart/form-data" name="kodeBarang">
...
$strRand = (String) $random;

?>
                <input type="text" class="form-control" name="kode" required="required" id="kodeproduk" placeholder="Masukkan Kode Produk .. (Wajib)">
              </div>

              <div class="form-group col-lg-2" style="margin-top: 25px;">
                <button onmouseup="generateRandomNumber()" class="btn btn-primary">Generate Kode</button>
              </div>
            </div>
...
?>
            ...
            <div class="form-group">
                <label>Barcode <small><i>Opsional</i></small></label>
...
function generateRandomNumber() {
    var random = Math.floor(Math.random() * (9999999999999 - 1000000000000 + 1)) + 1000000000000;
    var strRand = String(random);
    document.getElementById("kodeproduk").value = strRand;
}
</script>
