      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <a href="produk_barcode.php" class="btn btn-success btn-sm pull-right" style="margin-right: 10px;"><i class="fa fa-print"></i> &nbsp Print Barcode Produk</a>
          </div>
...
//                   $generator = new Picqer\Barcode\BarcodeGeneratorJPG();
    // file_put_contents("barcode.jpg", $generator->getBarcode($strRand, $generator::TYPE_EAN_13, 3, 70));
    ?>
                    <img style="display: block; margin: 30px; width: 280px;" src="../library/barcode.php?text=<?php echo $d['produk_kode'] ?>&print=true" alt="<?php echo $d['produk_kode'] ?>">
